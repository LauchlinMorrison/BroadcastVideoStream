...
def main():
    ...
    broadcaster = multiprocessing.Process(target=bc.capture_video, args=(source, frame_queue))
    broadcaster.start()

    # Start consumer processes
    consumers = []
    consumers.append(multiprocessing.Process(target=dc.display, args=(frame_queue, "Display Consumer")))
